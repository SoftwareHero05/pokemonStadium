...
public:
    ...
    void Iniciar()
    {
        try
        {
            ...
            image1.setImage(this->link.getPokemonImageDirectionWithString(this->link.GetPokemonActual(1), 1),manager, 2.2f, 1.5f, 70.0f, 210.0f);
            image2.setImage(this->link.getPokemonImageDirectionWithString(this->link.GetPokemonActual(2), 2), manager,2.0f, 1.3f, 280.0f, 20.0f);
    ...
    void drawTeam(sf::RenderWindow &window, sf::Event &event, sf::Clock &clock, int player)
    {
        ...
        for (auto &&pokemon : team)
        {
            ...
            this->buttonArregloPokemons[i].setButton(this->link.getPokemonImageDirectionWithString(pokemon, 2),manager, sf::Vector2f(x, y + a * 120.0f), this->link.getSpecificPokemonNameWithInt(i));
    ...
    {
        this->image3.setImage("./assets/images/textbox1.png", manager,.15f, .2f, 50.0f, 10.0f);
        this->image4.setImage("./assets/images/textbox1.png", manager,.17f, .2f, 280.0f, 230.0f);
        this->buttonArregloAction1[0].setButton("./assets/images/attackIcon.png",manager, sf::Vector2f(320.0f, 255.0f), "attack");
        this->buttonArregloAction1[1].setButton("./assets/images/changeIcon.png",manager, sf::Vector2f(400.0f, 255.0f), "change");
        this->buttonArregloAction2[0].setButton("./assets/images/attackIcon.png",manager,sf::Vector2f(30.0f, 40.0f), "attack");
        this->buttonArregloAction2[1].setButton("./assets/images/changeIcon.png",manager, sf::Vector2f(110.0f, 40.0f), "change");
